...
Let's fit a model to our observed relationship between 
Weight and the LDL concentration and inspect the result.
...
```{r}
ds1 <- read.csv( here("CODING_WEEK_2", "data", "DATA_FSB_SET_1.csv" ), row.names = 1)
```
## Fit a linear model
```{r}
