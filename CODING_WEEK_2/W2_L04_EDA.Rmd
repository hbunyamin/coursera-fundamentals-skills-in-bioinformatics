---
title: "W2_L04_EDA Coding Lecture"
...
library(ggplot2)
library(here)
here::i_am("W2_L04_EDA.Rmd")
```

## Let us load the data
```{r}
ds2 <- read.csv( here::here("data", "DATA_FSB_SET_2.csv" ), row.names = 1)
...
First, we need to understand the basic structure of ggplot2 comands. 
Let's say we want to understand the relationship between the weight of 
our patients and their blood LDL levels. This is how the plot is then setup.
...
It seems, we have two groups of variables which are related to each other. 
This result looks familiar, as the clustering structure is similar to the 
relative placement of variables in the first and second PCA component plot above.
